...
//    private static final String LOAD_MESSAGES = "SELECT MessageID, MessageText FROM DE_Messages WHERE CAST(MessageID AS VARCHAR(10)) != MessageText AND MessageID >= @@From AND MessageID <= @@To AND LanguageID = 1 AND WorkingCopyID = " + workingCopyId;
    private static final String LOAD_MESSAGES = "SELECT MessageID, MessageText FROM DE_Messages WHERE CAST(MessageID AS VARCHAR(10)) != MessageText AND MessageID >= @@From AND MessageID <= @@To AND WorkingCopyID = " + workingCopyId + " GROUP BY MessageID, MessageText";
